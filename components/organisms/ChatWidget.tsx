...
export function ChatWidget() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-40 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-2xl transition-all duration-300 hover:scale-110 flex items-center gap-3 group animate-pulse hover:animate-none"
